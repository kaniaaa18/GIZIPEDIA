...
<body class="index-page">
    ...
    <!-- Food by Category Section -->
    <section id="foods" class="team section light-background">

        <!-- Section Title -->
        <div class="container section-title" data-aos="fade-up">
            <h2>{{ $category->name }}</h2>
            <div><span>Lihat daftar makanan di kategori</span> <span
                    class="description-title">{{ $category->name }}</span></div>
                    ...
                    <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
                        <div class="team-member d-flex">
                            <div class="member-img">
                                <img src="{{ asset('storage/' . $food->image) }}" class="img-fluid" alt="{{ $food->name }}"
                                    loading="lazy">
                            </div>
                            <div class="member-info flex-grow-1">
                                ...
                                <p>
                                    <strong>Kalori:</strong> {{ $food->calories }} kkal<br>
                                    <strong>Karbohidrat:</strong> {{ $food->carbohydrate }} gr<br>
                                    <strong>Protein:</strong> {{ $food->protein }} gr<br>
                                    <strong>Lemak:</strong> {{ $food->fat }} gr
                                </p>
                                {{-- Optional: tambahkan link detail jika ada --}}
                                {{-- <a href="{{ route('food.show', $food->slug) }}">Lihat detail</a> --}}
                            </div>
                        </div>
                    </div><!-- End Food Item -->
                @empty
                    <div class="col-12 text-center">
                        <p>Belum ada makanan pada kategori ini.</p>
                    </div>
                @endforelse
            </div>
    ...
    </section><!-- /Food by Category Section -->
