...
<body class="index-page">
    ...
    <div class="recipe-detail container"
        ...
        <h2>Salad Quinoa dengan Buah</h2>
        ...
        <ul>
            <li>150 g quinoa</li>
            <li>1 buah mangga, potong dadu</li>
            <li>1 buah apel, potong dadu</li>
            <li>100 g kacang tanah, sangrai</li>
            <li>2 sdm lemon juice</li>
        ...
        <h3>Cara Membuat:</h3>
        <ol>
            <li>Masak quinoa dalam panci dengan air hingga mendidih, lalu kecilkan api dan masak selama 15 menit.
                Tiriskan.</li>
            <li>Campurkan quinoa yang sudah dimasak dengan potongan mangga, apel, dan kacang tanah dalam mangkuk.</li>
            <li>Tambahkan lemon juice dan garam, aduk hingga tercampur rata.</li>
